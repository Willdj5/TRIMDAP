function [configs] = config1(aerofoilData, configs)
%% FINAL DESIGN
data = struct();
...
data.cmpnt.sec.fuselarge    = struct('m', 0, ...
                            'x', 1.6, 'y', 0, 'z', 0, ...
                            'xl', 3.2, 'yl', 0.5, 'zl', 0.5);

data.cmpnt.payload.p1       = struct('m', 450, ...
                            'x', 1.73, 'y', 0, 'z', -0.071, ...
...
data.use.wing = 'Rectangular';
data.use.tail = 'Rectangular';
